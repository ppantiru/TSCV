...
function ProblemSolving() {
	...
	<a className='getDoc' href='https://docs.google.com/document/d/19SaybC8GulX-1uEEeADJ5_rycpd47oWIDQIeEhhrH7w/edit?usp=sharing' target="_blank">Download document</a>
		...
		<p className="c1">
			<span className="c1">
				<strong>
					{"{"}Input{"}"} =&gt; f(ideas, perspective, actions, interval) =&gt; {"{"}
			Output{"}"}
				</strong>
			</span>
		</p>
		...
		<p className="c0">
			...
			<br />
			Input = The state at the moment of time T1 representing the “problem”
			<br />
			Output = the state at the moment of time T2 representing the “best outcome
			/ objective”
			<br />
